...
// -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
// code from lpwm/lpwm.html
// -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
// var params = getURLParams(window.location.search);  // original
var params = {};  // my edit to get this to work


let site = params.site || "";
let username = params.username || "";
let isAsyncIdentity = params.async_identity === "true";
let isSecureIdentity = params.secure_identity === "true";
let isCdnTagJs = params.cdn_tag_js === "true";
// -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
