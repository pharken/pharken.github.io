...
/*
    ...
    New page:
    Copy the demo.html page and give it a name
...
const projectDataset = [
    ...
    ["VZ-Prod", "23979466", "LP_RSASurvey_Test", [ "rsasurvey", "vzprod" ], "<span class='fa fa-lg fa-warning isOff'></span> Emergency RSA satellite test, campaign: vzstore", "" ],
    ["VZ-QA-Tracfone", "42268356", "---",   [], "Tracfone QA acct demo page", "/demo/tracfone"],
    ["TracfoneDemo", "91614185", "---", [], "<span class='fa fa-lg fa-warning isBlue'></span> Tracfone demo page", "/demo/tracfone"],
    ...
    ["VZ-fast",  "88102062", "---",  [ "l2:business", "l3:shop", "l4:uc", "l5:contact-us", "source:digquote-d2d" ], "Old, not sure", "/demo/customer" ],
    ...
    ["GoldmanSachs_QA", "36416044", "N/A", [ "lptest" ], "Test page for the Key Phrase Observer controller bot", "/demo/customer" ],
...
const initDataTable = () => {
    ...
    // bind table row button click to create href URL and trigger
